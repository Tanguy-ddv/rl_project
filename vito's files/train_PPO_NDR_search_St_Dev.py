...
def main():
    ...
    #this is useful for the git version of the file to create a new folder (if it doesn't exist) in which is possible to insert the different models
    ...
    plt.plot(std_devs_from_file, results_target_from_file, marker='o', color='blue')
    plt.xlabel('Standard Deviation')
    plt.ylabel('Mean Reward')
    plt.title('Performance of PPO with Normal Domain Randomization on different standard deviation')
    plt.grid(True)
    plt.xticks(std_devs_from_file)  #For a more correct x-axis
